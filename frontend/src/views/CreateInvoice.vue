<template>
  <div>
    ...
    <div class="invoice-step" v-if="invoiceStep === 3">
      ...
      <custom-button @button:click="submitInvoice"
        >Submit Invoice</custom-button
      >
      <hr />
    ...
    <div class="invoice-steps-actions">
      <custom-button @button:click="prev" :disabled="!canGoPrev"
        >Previous</custom-button
      >
      <custom-button @button:click="next" :disabled="!canGoNext"
        >Next</custom-button
      >
      <custom-button @button:click="startOver">Start Over</custom-button>
    </div>
  </div>
</template>
...
@Component({ name: "CreateInvoice", components: { CustomButton } })
